...
export function CookiePolicy({ onBack }: CookiePolicyProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-white">
      {/* Header */}
      <div className="bg-gradient-to-r from-yellow-600 to-orange-600 text-black">
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="bg-gradient-to-r from-orange-600 to-yellow-600 text-black">
            <CardContent className="p-8 text-center">
              ...
              <div className="text-center text-black/90 text-sm">
                <p>
