                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <a
                      ...
                      className="w-9 h-9 bg-gray-100 rounded-lg flex items-center justify-center hover:bg-orange-600 hover:text-black transition-all duration-200 text-gray-600"
                    >
