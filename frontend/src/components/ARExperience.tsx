...
export function ARExperience({ experience = mockARExperience, onClose }: ARExperienceProps) {
  ...
  const renderStartScreen = () => (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 text-black">
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <div className="flex items-center justify-between mb-8">
          <Button variant="outline" onClick={onClose} className="text-black border-white/20 hover:bg-white/10">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {experience.features.map((feature, index) => (
              <Card key={index} className="p-4 bg-white/10 border-white/20 text-black">
          ...
          {/* System Requirements */}
          <Card className="p-6 bg-white/10 border-white/20 text-black max-w-2xl mx-auto">
          ...
          <div className="space-y-4">
            {!arSupported ? (
              <div className="space-y-4">
                ...
                <Button variant="outline" className="text-black border-white/20" disabled>
                  AR Not Available
                </Button>
              </div>
              ...
              <div className="space-y-4">
                ...
                <Button variant="outline" onClick={requestCameraPermission} className="text-black border-white/20">
    ...
    <div className="fixed inset-0 bg-black">
        ...
        {experience.hotspots.map((hotspot) => (
          ...
          >
            ...
            <div className="absolute top-10 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
              <Badge className="bg-black/70 text-black text-xs">
                {hotspot.title}
              </Badge>
            </div>
          </div>
      ...
      <div className="absolute top-4 left-4 right-4 flex justify-between items-start">
        <Button 
          ...
          className="bg-black/50 text-black border-white/30 hover:bg-black/70"
        >
          <X className="w-4 h-4" />
        </Button>
      ...
      {showControls && (
        <div className="absolute bottom-4 left-4 right-4">
          <Card className="p-4 bg-black/70 text-black border-white/20">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Button
                  ...
                  className={`text-black hover:bg-white/20 ${isRecording ? 'bg-red-500/30' : ''}`}
                >
      ...
      {showInfo && (
        <div className="absolute top-16 left-4 right-4">
          <Card className="p-4 bg-black/80 text-black border-white/20">
      ...
      {activeHotspot && (
        <div className="absolute inset-x-4 bottom-20">
          <Card className="p-6 bg-black/90 text-black border-white/20">
            {(() => {
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm text-black/80">{hotspot.description}</p>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"
                  ...
                  {hotspot.content?.audio && (
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-xs text-black/70">{hotspot.content.audio}</span>
                    </div>
                  )}
                </div>
              );
      ...
      {isRecording && (
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2">
          <div className="flex items-center space-x-2 bg-red-500/80 px-3 py-1 rounded-full">
            ...
            <span className="text-black text-xs font-medium">Recording</span>
          </div>
        </div>
      )}
    </div>
