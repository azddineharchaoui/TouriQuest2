/**
 * PriceComparisonWidget Component
...
export const PriceComparisonWidget: React.FC<PriceComparisonWidgetProps> = ({
  ...
  // Query for price comparison data
  const { data: priceData, isLoading } = useQuery({
    queryKey: ['properties', 'price-comparison', location, checkIn, checkOut],
  ...
  return (
    <Card className={`p-6 ${className}`}>
      ...
      {/* Historical Trend */}
      {priceData.historicalData && priceData.historicalData.length > 0 && (
        <div className="mt-6">
