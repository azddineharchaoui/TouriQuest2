            ...
            <div className="flex space-x-1">
              <button
                ...
                className={`px-3 py-1 text-sm rounded-md ${
                  selectedView === 'map' ? 'bg-primary text-white' : 'bg-muted'
                }`}
              >
                Map
              </button>
              <button
                ...
                className={`px-3 py-1 text-sm rounded-md ${
                  selectedView === 'timeline' ? 'bg-primary text-white' : 'bg-muted'
                }`}
              >
                Timeline
              </button>
              <button
                ...
                className={`px-3 py-1 text-sm rounded-md ${
                  selectedView === 'destinations' ? 'bg-primary text-white' : 'bg-muted'
                }`}
              >
                Favorites
              </button>
