              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className={`text-xs ${active ? 'text-white/70' : 'text-medium-gray'}`}>
                      {item.description}
                    </p>
                  </div>
                </button>
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Button variant="ghost" size="sm" className="relative">
              ...
              <Badge className="absolute -top-1 -right-1 h-5 w-5 flex items-center justify-center p-0 bg-secondary-orange text-white text-xs">
                3
              </Badge>
            </Button>
